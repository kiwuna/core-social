...
async function promoteSoko() {
  ...
  try {
    ...
    if (resCheck.rowCount === 0) {
      console.log("User 'soko' not found in database. Setting up auto-promotion on login.");
    } else {
    ...
    if (resUpdate.rowCount > 0) {
      ...
      console.log("Could not update. User 'soko' may not exist yet, but will be auto-promoted when they register or log in!");
    }
  } catch (err) {
